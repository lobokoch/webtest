...
export class ContaBancariaService {
	...
	url = environment.apiUrl + '/kerubin/clientes/entities/contaBancaria';
	...
	private adjustEntityDates(entityList: ContaBancaria[]) {
		entityList.forEach(contaBancaria => {
		      if (contaBancaria.validade) {
		        contaBancaria.validade = moment(contaBancaria.validade, 'YYYY-MM-DD').toDate();
		      }
